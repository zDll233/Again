        ...
        Obx(() => Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: audioController.playerState.value == PlayerState.playing ? null : audioController.resume,
              iconSize: 48.0,
            ...
            IconButton(
              ...
              onPressed: audioController.playerState.value == PlayerState.playing ? audioController.pause : null,
              iconSize: 48.0,
            ...
            IconButton(
              ...
              onPressed: audioController.playerState.value == PlayerState.playing || audioController.playerState.value == PlayerState.paused ? audioController.stop : null,
              iconSize: 48.0,
